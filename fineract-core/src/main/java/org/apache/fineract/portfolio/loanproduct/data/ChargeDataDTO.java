...
public class ChargeDataDTO implements Serializable {
    ...
    private PaymentTypeDataDTO paymentTypeOptions;
    ...
    private GLAccountDataDTO incomeOrLiabilityAccount;
    private TaxGroupDataDTO taxGroup;
    ...
    private List<EnumOptionData> chargePaymentModeOptions;
    ...
    private Map<String, List<GLAccountDataDTO>> incomeOrLiabilityAccountOptions;
    private List<TaxGroupDataDTO> taxGroupOptions;

    private String accountMappingForChargeConfig;
    private List<GLAccountDataDTO> expenseAccountOptions;
    private List<GLAccountDataDTO> assetAccountOptions;
}
