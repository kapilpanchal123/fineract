...
import org.apache.fineract.portfolio.loanproduct.data.LoanProductDTOData;
...
public class LoanProductsApiResource {
    ...
    private final DefaultToApiJsonSerializer<LoanProductDTOData> toApiJsonSerializer;
    ...
    // @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation =
    // LoanProductsApiResourceSwagger.PostLoanProductsResponse.class))) })
    public LoanProductRequest createLoanProductNewCommandInfrastructure(
            @Parameter(hidden = false) final LoanProductRequest loanProductRequest) {
    ...
    public String retrieveAllLoanProducts(@Context final UriInfo uriInfo) {
        ...
        final Collection<LoanProductDTOData> products = this.loanProductReadPlatformService.retrieveAllLoanProducts();
    ...
    public String retrieveTemplate(@Context final UriInfo uriInfo,
        ...
        if (isProductMixTemplate) {
            ...
            final Collection<LoanProductDTOData> productOptions = this.loanProductReadPlatformService.retrieveAvailableLoanProductsForMix();
        ...
        LoanProductDTOData loanProduct = this.loanProductReadPlatformService.retrieveNewLoanProductDetails();
    ...
    private String getLoanProductDetails(Long productId, UriInfo uriInfo) {
        ...
        LoanProductDTOData loanProduct = this.loanProductReadPlatformService.retrieveLoanProduct(productId);
        ...
        if (loanProduct.hasAccountingEnabled()) {
            ...
            loanProduct = LoanProductDTOData.withAccountingDetails(loanProduct, accountingMappings, paymentChannelToFundSourceMappings,
    ...
    private LoanProductDTOData handleTemplate(final LoanProductDTOData productData) {
        ...
        return new LoanProductDTOData(productData, chargeOptions, penaltyOptions, paymentTypeOptions, currencyOptions, amortizationTypeOptions,
